...
//    std::cout << "########################### checkAuthorizationImplPreParse" << std::endl;
...
//    std::cout << "########################### runCommandDirectly" << std::endl;
...
//    std::cout << "########################### auditLogAuthEvent" << std::endl;
...
//    std::cout << "########################### auditLogAuthEventEND" << std::endl;
}
...
//    std::cout << "########################### parseNsCollectionRequired" << std::endl;
...
//    std::cout << "########################### parseNsOrUUID" << std::endl;
    BSONElement first = cmdObj.firstElement();
...
//    std::cout << "########################### parseNsFromCommand" << std::endl;
    BSONElement first = cmdObj.firstElement();
...
//    std::cout << "########################### resourcePatternForNamespace" << std::endl;
...
//    std::cout << "########################### findCommand------------->" << name << std::endl;
...
//    std::cout << "########################### registerCommand"<< std::endl;
...
//    std::cout << "########################### rRegistry::findCommand"<< std::endl;
...
//    std::cout << "########################### globalCommandRegistry"<< std::endl;
